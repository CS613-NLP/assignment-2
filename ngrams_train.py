...
unigram.calc_perplexity(df_train, smoothing="laplace",
                        save_csv='language_models/unigram_perplexity_laplace_train.csv', log_prob_save_csv='language_models/unigram_log_prob_laplace_train.csv')
unigram.calc_perplexity(df_test, smoothing="laplace",
                        save_csv='language_models/unigram_perplexity_laplace_test.csv', log_prob_save_csv='language_models/unigram_log_prob_laplace_test.csv')
...
bigram.calc_perplexity(df_test, smoothing="laplace",
                       save_csv='language_models/bigram_perplexity_laplace_test.csv', log_prob_save_csv='language_models/bigram_log_prob_laplace_test.csv')
...
trigram.calc_perplexity(df_test, smoothing="laplace",
                        save_csv='language_models/trigram_perplexity_laplace_test.csv', log_prob_save_csv='language_models/trigram_log_prob_laplace_test.csv')
...
quadgram.calc_perplexity(df_test, smoothing="laplace",
                         save_csv='language_models/quadgram_perplexity_laplace_test.csv', log_prob_save_csv='language_models/quadgram_log_prob_laplace_test.csv')
